...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.addReview.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.add-reviews.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reviewer_name') ? 'is-invalid' : '' }}" type="text" name="reviewer_name" id="reviewer_name" value="{{ old('reviewer_name', '') }}" required>
