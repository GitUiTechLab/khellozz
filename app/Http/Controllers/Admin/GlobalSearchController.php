...
{
    private $models = [
        'SportCategory'  => 'cruds.sportCategory.title',
        'AddSport'       => 'cruds.addSport.title',
        'AddEvent'       => 'cruds.addEvent.title',
        'AddContestant'  => 'cruds.addContestant.title',
        'AddMedium'      => 'cruds.addMedium.title',
        'AddReview'      => 'cruds.addReview.title',
        'AddAchievement' => 'cruds.addAchievement.title',
        'ContactForm'    => 'cruds.contactForm.title',
        'AddPlayer'      => 'cruds.addPlayer.title',
    ];
